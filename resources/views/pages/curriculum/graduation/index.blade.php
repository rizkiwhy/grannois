                ...
                <div class="modal fade" id="importModal">
                    <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('graduation.import') }}" method="post" class="form-horizontal"
                                    ...
                                    <div class="position-relative p-3 bg-gray mb-3" style="width: 100%">
                                        ...
                                        <small>
                                            <ul>
                                                <li>Data Kelulusan dapat diimport menggunakan file dengan format excel
                                                    (.xlsx).
                                                </li>
                                                <li>Silahkan ubah data file berikut (<a
                                                        href="{{ asset('import/data_kelulusan.xlsx') }}" download>example
                                                        data
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input class="form-control" type="file" id="graduationData"
                                                    name="graduationData">
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-upload"></i></span>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="#" method="post" class="form-horizontal" id="deleteForm">
                                @method('delete')
                                @csrf
                                Apakah anda yakin akan menghapus Kelulusan <span name="textStudent"
                                    id="textStudent"></span>?
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
